/**
 * This program takes an input file and applies a subsitution cypher to it then inserts the encoded text into a new file.  
...
public class SubstitutionCypher {
    ...
    /**
     * Private constants used to shift characters for the substitution cypher.
     */
